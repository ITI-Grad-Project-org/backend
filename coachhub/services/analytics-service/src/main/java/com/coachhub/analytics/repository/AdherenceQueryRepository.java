...
public class AdherenceQueryRepository {
    ...
    /**
     * Denominator is the plan, not the logs: counting only logged_workouts would
     * measure "of the sessions they started, how many finished" and quietly
     * ignore every session they never opened — which is the population the
    ...
    /**
     * Volume compares against prescribed_reps_min — the floor of the prescribed
     * range. Clearing the bottom of an 8-12 range is compliance, so the midpoint
     * would report a compliant client as short.
     *
     * <p>Only sets carrying both a prescribed weight and a rep floor are
     * comparable; RPE- and %1RM-prescribed sets have no absolute target. Extra
     * sets are excluded entirely — by definition they have no prescription, and
     * counting them would let unprescribed work inflate adherence past 100%.
     */

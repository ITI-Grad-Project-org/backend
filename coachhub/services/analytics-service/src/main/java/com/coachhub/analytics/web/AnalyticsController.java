 ...
 * authenticating edge and is the only intended caller. Exposing this to the
 * browser requires real authorisation first.
 */
@RestController
...
public class AnalyticsController {
    ...
    @ApiResponses({
        ...
        @ApiResponse(responseCode = "400", description = "'to' is before 'from'", content = @io.swagger.v3.oas.annotations.media.Content)
    })
    ...
    @ApiResponses({
        ...
        @ApiResponse(responseCode = "404", description = "No such template for this tenant", content = @io.swagger.v3.oas.annotations.media.Content)
    })
